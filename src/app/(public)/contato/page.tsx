      ...
      <div className="space-y-8">
        ...
        <div className="space-y-4">
          <a
            ...
            className="flex items-center gap-4 p-4 bg-zinc-50 dark:bg-zinc-800/50 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors animate-fade-in-up delay-200"
          >
            ...
            <div>
              ...
              <p className="text-zinc-600 dark:text-zinc-400">seuemail@email.com</p>
            </div>
          </a>
          ...
          <a
            ...
            className="flex items-center gap-4 p-4 bg-zinc-50 dark:bg-zinc-800/50 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors animate-fade-in-up delay-300"
          >
            <div className="w-12 h-12 bg-zinc-200 dark:bg-zinc-700 rounded-full flex items-center justify-center">
            ...
            <div>
              ...
              <p className="text-zinc-600 dark:text-zinc-400">linkedin.com/in/seulinkedin</p>
            </div>
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-4 p-4 bg-zinc-50 dark:bg-zinc-800/50 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors animate-fade-in-up delay-400"
          >
            <div className="w-12 h-12 bg-zinc-200 dark:bg-zinc-700 rounded-full flex items-center justify-center">
              <svg className="w-6 h-6 text-zinc-600 dark:text-zinc-300" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <p className="text-zinc-600 dark:text-zinc-400">@seuinstagram</p>
            </div>
          </a>
        </div>
      </div>
